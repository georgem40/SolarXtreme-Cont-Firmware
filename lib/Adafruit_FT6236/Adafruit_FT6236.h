...
#ifndef ADAFRUIT_FT6236_LIBRARY
#define ADAFRUIT_FT6236_LIBRARY
...
#define FT6236_DEFAULT_THRESSHOLD 128
...
class Adafruit_FT6236 {
 public:

  Adafruit_FT6236(void);
  boolean begin(uint8_t thresh = FT6236_DEFAULT_THRESSHOLD);  
